...
class ExpressionWriter() {
    ...
    fun proceedAction(action: CalculatorAction) {
        when (action) {
            ...
            CalculatorAction.Delete -> {
                expression = expression.takeIf { it.isNotEmpty() }?.drop(1) ?: ""
            }
    ...
    private fun processParentheses(): String {
    ...
    private fun canEnterDecimal(): Boolean {
        ...
        return !expression.takeLastWhile { char ->
            char in "0123456789."
        }.contains(".")
    }
